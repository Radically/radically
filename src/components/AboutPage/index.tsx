...
import { github, discord, matrix } from "./links.json";
      ...
      <Switch>
        <Route exact path={path}>
          ...
          <IconDescRow
            ...
            desc={
              <SectionParagraph darkMode={darkMode}>
                Report issues, request new features, understand the inner
                workings of Radically, and join the discussion on{" "}
          ...
          <SectionParagraph darkMode={darkMode}>
            ❶ The IDCs in any of the IDSes of a resulting character must appear
            in the relative order entered.
          </SectionParagraph>
          ...
          <SectionParagraph darkMode={darkMode}>
            For instance, 人人人 matches 傘 (4x 人), 众 (3x 人), and 齒 (4x 人),
            and not 从 (2x 人), 纵 (2x 人), or 齿 (1x 人). 口土土 matches 哇 (1x
            口, 2x 土), and not 吐 (1x 口, 1x 土).
          </SectionParagraph>
          <SectionParagraph darkMode={darkMode}>
            ❸ Turn this on if your device is unresponsive while searching. As of
            the time of writing, nearly 99,000 characters are indexed. For
            efficient retrieval, the data is organized as a directed graph, i.e.
          </SectionParagraph>
          <SectionParagraph darkMode={darkMode}>
          ...
          <SectionParagraph darkMode={darkMode}>
            一 (as can be expected) is likely the worst-case single-character
            query: ~54,500 results, with ~64800 edges (pairs of characters)
            traversed; ~300 ms elapsed on a Snapdragon 425 phone. This process
            has to be repeated for each unique character entered.
          </SectionParagraph>
          <SectionParagraph darkMode={darkMode}>
            一丨人 consumes ~500-600 ms, traversing around 116,500 edges.
          </SectionParagraph>
          <SectionParagraph darkMode={darkMode}>
            The search will be offloaded to a web worker if turned on, to avoid
            the fairly unlikely situation where the UI thread is blocked for a
            long time. Very few characters have normalized IDSes composed of
            more than 5 or 6 unique characters, even in contrived situations
            such as U+291D2 <LargeSpan>𩇒</LargeSpan>, the infamous{" "}
            <LargeSpan>鬱</LargeSpan>, or{" "}
          ...
          <div>
            ...
            <SectionParagraph darkMode={darkMode}>
              ...
              - IDS strings (partially based on CHISE, thus GPLv2) and variants
              data
            </SectionParagraph>
            <SectionParagraph darkMode={darkMode}>
              <Link
